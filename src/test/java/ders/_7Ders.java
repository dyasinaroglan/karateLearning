...
public class _7Ders {
    ...
    """
         ...
         ve bu token'ı yetkilendirme için kullanarak yeni bir makale oluşturma isteği yaptınız.
             ...
             Parametre
                 #(email) ve #(password) dinamik değişkenlerdir. Yani, bu değerler farklı yerlerden gelecek ve her testte farklı değerlere sahip olabilir.
                 Karate, bu parametrelerin hangi değerlerle doldurulacağını çağıran yerden alır.
